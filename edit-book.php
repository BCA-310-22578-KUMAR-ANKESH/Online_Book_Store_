...
if(isset($_POST['submit']))
{
   ...
   $category=$_POST['category'];
    ...
    $bookpricebd=floatval($_POST['bookpricebd']);
    $bookpricead=floatval($_POST['bookpricead']);
    if ($bookpricebd < 1000 || $bookpricebd > 10000 || $bookpricead < 1000 || $bookpricead > 10000) {
        echo "<script>alert('Book price must be between ₹1,000 and ₹10,000.');</script>";
...
<div class="col-7"><input type="number" min="1000" max="10000" name="bookpricebd" value="<?php echo htmlentities($row['BookPriceBeforeDiscount']);?>" class="form-control" required>

</div>
</div>
<div class="row" style="margin-top:1%;">
<div class="col-3">Book Price After Discount(Selling Price)</div>
<div class="col-7"><input type="number" min="1000" max="10000" name="bookpricead" value="<?php echo htmlentities($row['BookPriceAfterDiscount']);?>" class="form-control" required>
