...
if($pqty == 0){
echo "<script>alert('Add add at least one product'); document.location ='" . $_SERVER['REQUEST_URI'] . "';</script>";
exit(1);
}
...
<?php if($row['BookAvailability']=='In Stock'):?>
										<input class="mtext-104 cl3 txt-center num-product"  id="inputQuantity" name="inputQuantity" type="num" value="1" min="1">
