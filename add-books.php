...
<div class="col-7"><input type="number" min="1000" max="10000" name="bookpricebd" placeholder="Enter Book Price (₹1000 - ₹10000)" class="form-control" required>
...
<div class="col-7"><input type="number" min="1000" max="10000" name="bookpricead" placeholder="Enter Book Price (₹1000 - ₹10000)" class="form-control" required>
