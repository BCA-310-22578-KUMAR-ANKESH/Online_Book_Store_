						...
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									Fiction Book by famous Authors
								</span>
							</div>
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="book-shop.php" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
...
<?php $query=mysqli_query($con,"select category.id as catid,category.categoryName from category limit 10");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?> 
					<a class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" href="categorywise-books.php?cid=<?php echo htmlentities($row['catid']);?>" target="blank">
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM tblbooks ");
    ...
    $query=mysqli_query($con,"select tblbooks.id as pid,tblbooks.BookImage1,tblbooks.BookName,tblbooks.BookPriceBeforeDiscount,tblbooks.BookPriceAfterDiscount from tblbooks order by pid desc LIMIT $offset, $total_records_per_page ");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?> 
